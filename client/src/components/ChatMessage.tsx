...
const ChatMessage = ({
  ...
  return (
    ...
    >
      ...
      >
        {role === "user" ? (
          <div className="p-2 relative flex flex-col gap-1 rounded-lg rounded-br-none bg-primary">
          ...
          <div className="p-2 rounded-lg bg-gray-100 flex flex-col gap-1 relative rounded-bl-none text-gray-800">
